	...
	<div class="flex justify-between items-center">
		...
		{:else}
			<div class="grid grid-cols-3 gap-1">
				...
				<a href="whatsapp://send?text=%20https://signs.rcastellotti.dev/{sign.slug}">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="16"
						height="16"
						fill="currentColor"
						class="whatsapp rounded-lg p-1 h-8 w-8 text-yellow-400 hover:bg-yellow-400 hover:text-black"
						viewBox="0 0 16 16"
					>
						<path
				...
				>
					<svg
						...
						height="16"
						fill="currentColor"
						class="twitter rounded-lg p-1 h-8 w-8 text-yellow-400 hover:bg-yellow-400 hover:text-black"
						viewBox="0 0 16 16"
					>
						<path
